...
//            if (val == 1) {
//                return new Font("Lucida Grande", Font.BOLD, 17);
//            } else if (val == 2) {
//                return new Font("Lucida Grande", Font.BOLD, 138);
//            } else
//                return null;
//        }
//
...
//            String retTxt = null;
//            if (val == 1) {
//                retTxt = "To start playing, press Play in the menu bar and choose level";
//            } else if (val == 2) {
//                retTxt = "Or select level by pressing 1, 2 or 3";
//            } else if (val == 3) {
//                retTxt = "Moves: ";
//            } else if (val == 4) {
//                retTxt = "Pushes: ";
...
//                retTxt = "LEVEL 3";
//            } else if (val == 9) {
//                retTxt = "You completed the level !";
//            }
//            return retTxt;
//        }
//
